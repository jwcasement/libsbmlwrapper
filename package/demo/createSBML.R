# # Example code for creating example SBML models presented in the SBML specification.
# # Taken from http://frank-fbergmann.blogspot.co.uk/2012/07/r-bindings-for-libsbml-550.html
# # 
